...
<script>
  ...
  export default {
    name: 'TileClickrateautoComponent',
    ...
    data () {
      return {
        ...
        chartOptions: {
          ...
          title: {
            text: this.trans('dashboard.clickrate_auto')
          },
          xAxis: {
            type: 'datetime',
    ...
    methods: {
      ...
      loadOfferByMonth: function (whitelabelId = null, start = '', end = '') {
        ...
        this.$http.get(window.laroute.route('admin.dashboard.events.clickRateauto') + params + paramsdate)
