...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/demo/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/demo/css/demo.css') }}">
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/demo/js/demo.js') }}"></script>
@endsection
