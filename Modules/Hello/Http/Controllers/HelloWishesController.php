...
/**
 * Class HelloWishesController.
 */
class HelloWishesController extends Controller
{
    ...
    public function __construct(WishesRepository $wish, WhitelabelsRepository $whitelabel, CategoriesRepository $categories)
    {
        ...
        $this->whitelabelId = \Config::get('hello.id');
    ...
    public function view(Wish $wish)
    {
        ...
        return view('hello::wish.wish')->with([
            'wish'               => $wish,
            'avatar'             => $avatar,
    ...
    public function validateTokenList($token)
    {
        ...
        if ($this->wish->validateToken($token)) {
            if (Route::has('hello.list')) {
                return redirect()->route('hello.list');
            }
        }
    ...
    {
        //var_dump($request->ip());
        return view('hello::wish.index')->with([
            'status'     => $this->status,
