    ...
    <div class="kwp-content kwp-with-expansion">
        <div class="kwp-row">
            <div class="kwp-col-4 destination">
                {{ Form::label('destination', trans('test::layer.general.destination'), ['class' => 'control-label required']) }}
                {{ Form::text('destination', null, ['class' => 'form-control box-size','autocomplete' => "off", 'placeholder' => trans('test::layer.placeholder.destination'), 'required' => 'required']) }}
                <i class="master-icon--location-fill"></i>
            </div>

            <div class="kwp-col-4">
                {{ Form::label('airport', trans('test::layer.general.airport'), ['class' => 'control-label required']) }}
                {{ Form::text('airport', null, ['class' => 'form-control box-size','autocomplete' => "off", 'placeholder' => trans('test::layer.placeholder.airport'), 'required' => 'required']) }}
            ...
            <div class="kwp-col-4 duration-col main-col">
                <div class="kwp-form-group duration-group">
                    ...
                    <div class="duration-more">
                        <div class="kwp-col-4">
                            {{ Form::label('earliest_start', trans('test::layer.general.earliest_start'), ['class' => 'control-label required']) }}
                            {{ Form::text('earliest_start', null, ['class' => 'form-control box-size', 'placeholder' => trans('test::layer.general.earliest_start'), 'required' => 'required']) }}
                        ...
                        <div class="kwp-col-4">
                            {{ Form::label('latest_return', trans('test::layer.general.latest_return'), ['class' => 'control-label required']) }}
                            {{ Form::text('latest_return', null, ['class' => 'form-control box-size', 'placeholder' => trans('test::layer.general.latest_return'), 'required' => 'required']) }}
                        ...
                        <div class="kwp-col-12">
                            {{ Form::label('duration', trans('test::layer.general.duration'), ['class' => 'control-label required']) }}
                            <div class="kwp-custom-select">
                                {{ Form::select('duration', array_merge(['' => trans('test::layer.general.duration_empty')], $duration_arr), ['class' => 'form-control box-size']) }}
                            </div>
        ...
        <div class="kwp-row">
            <div class="kwp-col-3 rangeslider-wrapper">
                <div class="kwp-form-group ">
                    ...
                    {{ Form::number('budget', old('budget'), ['class' => 'form-control box-size hidden', 'placeholder' => trans('test::layer.placeholder.budget'), 'required' => 'required']) }}
                </div>
            ...
            <div class="kwp-col-3 white-col stars">
                <div class="kwp-form-group">
                    ...
                    {{ Form::number('category', old('category'), ['class' => 'form-control box-size hidden', 'placeholder' => trans('test::layer.placeholder.category')]) }}
        ...
        <div class="kwp-row">
            <div class="kwp-col-12 description">
                ...
                {{ Form::textarea('description', null,['class' => 'form-control', 'placeholder' => trans('test::layer.placeholder.description')]) }}
                <i class="master-icon--calendar-month"></i>
            </div>
        </div>
        ...
        <div class="kwp-row">
            <div class="kwp-col-4 email-col">
                ...
                {{ Form::text('email', null, ['class' => 'form-control box-size', 'placeholder' => trans('test::layer.placeholder.email'), 'required' => 'required']) }}
