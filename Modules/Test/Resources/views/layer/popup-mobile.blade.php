...
{{ Form::open(['route' => 'test.store' , 'method' => 'get', 'class' => '', 'role' => 'form', 'files' => true]) }}
                    ...
                    <div class="duration-more">
                        ...
                        <div class="kwp-col-12">
                            ...
                            <div class="kwp-custom-select">
                                {{ Form::select('duration', array_merge(['' => trans('test::layer.general.duration_empty')], $duration_arr), key_exists('duration', $request) ? $request['duration'] : null, ['class' => 'form-control box-size']) }}
                            </div>
