...
namespace Modules\HamburgReisen\Http\Controllers;
...
use Modules\HamburgReisen\Http\Requests\StoreWishRequest;

class HamburgReisenController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('hamburgreisen.id');
    }
    ...
    {
        $whitelabel = $this->whitelabel->getByName('HamburgReisen');

        return view('hamburgreisen::index')->with([
    ...
    {
        $html = view('hamburgreisen::layer.popup')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('hamburgreisen::layer.created')->with([
