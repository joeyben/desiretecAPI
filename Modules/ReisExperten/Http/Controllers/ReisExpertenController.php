...
namespace Modules\ReisExperten\Http\Controllers;
...
use Modules\ReisExperten\Http\Requests\StoreWishRequest;

class ReisExpertenController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('reisexperten.id');
    }
    ...
    {
        $whitelabel = $this->whitelabel->getByName('ReisExperten');

        return view('reisexperten::index')->with([
    ...
    public function show(Request $request)
    {
        ...
        $html = view('reisexperten::'.$layer)->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('reisexperten::layer.created')->with([
