{{ Form::model($logged_in_user, ['route' => 'frontend.user.profile.update', 'class' => 'form-horizontal', 'method' => 'PATCH']) }}
    ...
    {{-- state --}}
    <div class="form-group">
        {{ Form::label('state', trans('validation.attributes.frontend.register-user.state'), ['class' => 'col-md-4 control-label']) }}
        <div class="col-md-6">
            {{ Form::input('text', 'state' , null, ['class' => 'form-control select2', 'placeholder' => trans('validation.attributes.frontend.register-user.state'), 'id' => 'state', 'style' => 'width : 539px !important;']) }}
        </div><!--col-md-6-->
    </div><!--form-group-->
