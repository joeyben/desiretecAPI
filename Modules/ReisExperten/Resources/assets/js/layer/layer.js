...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'https://reisexperten.reise-wunsch.com',
        logoPath: '/whitelabel/reisexperten/images/layer/logo.png',
        popupPath: '/show',
        popupStore:'/store',
    ...
    var KwizzmeFakeTripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        name: 'Master WL',
        matchesUrl: 'reisexperten.reise-wunsch.com',
