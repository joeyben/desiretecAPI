...
import CssConfig from './CssConfig.js'
  ...
  export default {
    ...
    data () {
      return {
        apiUrl: window.laroute.route('admin.whitelabels.list'),
    ...
    methods: {
      ...
      onDelete (id) {
        this.$store.dispatch('block', {element: 'whitelabelsComponent', load: true})
        this.$http.delete(window.laroute.route('admin.whitelabels.destroy', {id: id}))
      ...
      onForceDelete (id) {
        ...
        this.$http.delete(laroute.route('admin.whitelabels.forceDelete', {id: id}))
          .then(this.onDeleteSuccess)
          .catch(this.onFailed)
          .then(() => {
            this.$store.dispatch('block', {element: 'whitelabelsComponent', load: false})
      ...
      onRestore (id) {
        this.$store.dispatch('block', {element: 'whitelabelsComponent', load: true})
        // eslint-disable-next-line
        this.$http.put(window.laroute.route('admin.whitelabels.restore', {id: id}))
          .then(this.onDeleteSuccess)
          .catch(this.onFailed)
          .then(() => {
            this.$store.dispatch('block', {element: 'whitelabelsComponent', load: false})
