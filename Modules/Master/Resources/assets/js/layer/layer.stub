...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'http://$MODULE$.com',
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/$MODULE$/css/layer/whitelabel.css'
    };
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        name: 'TUI IBE',
        matchesUrl: 'www.master.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
