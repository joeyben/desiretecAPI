...
(function ($) {
    ...
    dt.defaultConfig = {
        ...
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/hello/css/layer/whitelabel.css'
    };
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        name: 'TUI IBE',
        matchesUrl: 'www.hello.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
    ...
    //    matchesUrl: 'hello.com/pauschalreisen',
