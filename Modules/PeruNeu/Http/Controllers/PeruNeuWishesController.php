...
/**
 * Class PeruNeuWishesController.
 */
class PeruNeuWishesController extends Controller
{
    ...
    public function view(Wish $wish)
    {
        ...
        return view('peruneu::wish.wish')->with([
            'wish'               => $wish,
            'avatar'             => $avatar,
    ...
    public function validateTokenList($token)
    {
        ...
        if ($this->wish->validateToken($token)) {
            if (Route::has('peruneu.list')) {
                return redirect()->route('peruneu.list');
            }
        }
    ...
    {
        //var_dump($request->ip());
        return view('peruneu::wish.index')->with([
            'status'     => $this->status,
