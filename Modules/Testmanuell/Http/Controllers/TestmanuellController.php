...
use Modules\Testmanuell\Http\Requests\StoreWishRequest;

class TestmanuellController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Testmanuell');

        return view('testmanuell::index')->with([
    ...
    public function show(Request $request)
    {
        ...
        $html = view('testmanuell::' . $layer)->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('testmanuell::layer.created')->with([
