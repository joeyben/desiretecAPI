...
namespace Modules\DesiretecReisewunschportal\Http\Controllers;
...
use Modules\DesiretecReisewunschportal\Http\Requests\StoreWishRequest;

class DesiretecReisewunschportalController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('desiretecreisewunschportal.id');
    }
    ...
    {
        $whitelabel = $this->whitelabel->getByName('DesiretecReisewunschportal');

        return view('desiretecreisewunschportal::index')->with([
    ...
    {
        $html = view('desiretecreisewunschportal::layer.popup')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('desiretecreisewunschportal::layer.created')->with([
