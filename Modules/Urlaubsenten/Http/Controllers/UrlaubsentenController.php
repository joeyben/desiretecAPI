...
namespace Modules\Urlaubsenten\Http\Controllers;
...
use Modules\Urlaubsenten\Http\Requests\StoreWishRequest;

class UrlaubsentenController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Urlaubsenten');

        return view('urlaubsenten::index')->with([
    ...
    public function show(Request $request)
    {
        ...
        $html = view('urlaubsenten::'.$layer)->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('urlaubsenten::layer.created')->with([
    ...
    public function getPDF()
        {
            return view('urlaubsenten::layer.pdf');
        }
}
