...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/holiday123/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/holiday123/css/holiday123.css') }}">
@endsection
...
@section('footer')
    @include('holiday123::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/holiday123/js/holiday123.js') }}"></script>
@endsection
