...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/example/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/example/css/example.css') }}">
@endsection
...
@section('footer')
    @include('example::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/example/js/example.js') }}"></script>
@endsection
