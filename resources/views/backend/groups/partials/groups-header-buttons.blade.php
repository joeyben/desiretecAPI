<!--Action Button-->
    @if(Active::checkUriPattern('admin/groups'))
        <div class="btn-group">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.groups.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.groups.all')}}</a></li>
    @permission('create-blog')
    <li><a href="{{route('admin.groups.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.groups.create')}}</a></li>
    @endauth
  </ul>
</div>
