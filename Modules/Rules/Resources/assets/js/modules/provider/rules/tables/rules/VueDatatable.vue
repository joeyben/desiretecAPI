...
import CssConfig from './CssConfig.js'
  ...
  export default {
    ...
    data () {
      return {
        apiUrl: window.laroute.route('admin.rules.view'),
    ...
    methods: {
      ...
      onDelete (id) {
        this.$store.dispatch('block', {element: 'rulesComponent', load: true})
        this.$http.delete(window.laroute.route('admin.rules.destroy', {id: id}))
      ...
      onForceDelete (id) {
        ...
        this.$http.delete(laroute.route('admin.rules.forceDelete', {id: id}))
          .then(this.onDeleteSuccess)
          .catch(this.onFailed)
          .then(() => {
            this.$store.dispatch('block', {element: 'rulesComponent', load: false})
      ...
      onRestore (id) {
        this.$store.dispatch('block', {element: 'rulesComponent', load: true})
        // eslint-disable-next-line
        this.$http.put(window.laroute.route('admin.rules.restore', {id: id}))
          .then(this.onDeleteSuccess)
          .catch(this.onFailed)
          .then(() => {
            this.$store.dispatch('block', {element: 'rulesComponent', load: false})
