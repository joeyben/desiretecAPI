<div class="kwp-content kwp-completed-master">
    ...
    <p>
        ...
        Wenn Sie Ihren Reisewunsch noch einmal überprüfen oder ändern möchten, <a  href="{{ route('desiretecreisewunschportal.wish.details', [$id, $token]) }}" target="_blank">klicken Sie bitte hier.</a>
    </p>
</div>
