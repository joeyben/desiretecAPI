...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/bentour/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/bentour/css/bentour.css') }}">
@endsection
...
@section('footer')
    @include('bentour::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/bentour/js/bentour.js') }}"></script>
@endsection
