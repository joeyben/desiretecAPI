...
use Modules\Traveloverland\Http\Requests\StoreWishRequest;

class TraveloverlandController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function index()
    {
        ...
        return view('traveloverland::index')->with([
    ...
    public function show(Request $request)
    {
        ...
        $html = view('traveloverland::layer.popup')->with([
