...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/sarahsluxusreisen/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/sarahsluxusreisen/css/sarahsluxusreisen.css') }}">
@endsection
...
@section('footer')
    @include('sarahsluxusreisen::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/sarahsluxusreisen/js/sarahsluxusreisen.js') }}"></script>
@endsection
