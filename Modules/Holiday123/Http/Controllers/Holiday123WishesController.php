...
/**
 * Class Holiday123WishesController.
 */
class Holiday123WishesController extends Controller
{
    ...
    public function view(Wish $wish)
    {
        ...
        return view('master::wish.wish')->with([
            'wish'               => $wish,
            'avatar'             => $avatar,
    ...
    public function validateTokenList($token)
    {
        ...
        if ($this->wish->validateToken($token)) {
            if (Route::has('holiday123.list')) {
                return redirect()->route('holiday123.list');
            }
        }
    ...
    public function wishList(ManageWishesRequest $request)
    {
        ...
        return view('holiday123::wish.index')->with([
            'status'     => $this->status,
