...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'https://trendtours.reise-wunsch.com',
        popupPath: '/show',
        popupStore:'/store',
    ...
    dt.popupTemplate = function (variant) {
        ...
        var texts = {
            'eil-n1': {
                ...
                body: 'Gerne unterstützen wir Sie bei der Planung Ihrer Reise! Tragen Sie einfach Ihre Wunsch-Daten ein, damit wir Ihnen ein passendes Angebot zusammenstellen können.'
            },
            'eil-mobile': {
                header: mobileHeader,
