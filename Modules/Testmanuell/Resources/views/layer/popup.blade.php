    ...
    <div class="kwp-content kwp-with-expansion">
        <div class="kwp-row">
            <div class="kwp-col-4 destination">
                ...
                {{ Form::text('destination', key_exists('destination', $request) ? $request['destination'] : null, ['class' => 'form-control box-size','autocomplete' => "off", 'placeholder' => trans('testmanuell::layer.placeholder.destination'), 'required' => 'required']) }}
            ...
            <div class="kwp-col-4">
                ...
                {{ Form::text('airport', key_exists('airport', $request) ? $request['airport'] : null, ['class' => 'form-control box-size','autocomplete' => "off", 'placeholder' => trans('testmanuell::layer.placeholder.airport'), 'required' => 'required']) }}
        ...
        <div class="kwp-row">
                ...
                <div class="kwp-form-group duration-group">
                    ...
                    <div class="duration-more">
                        <div class="kwp-col-4">
                            ...
                            {{ Form::text('earliest_start', key_exists('earliest_start', $request) ? $request['earliest_start'] : null, ['class' => 'form-control box-size', 'placeholder' => trans('testmanuell::layer.general.earliest_start'), 'required' => 'required']) }}
                        ...
                        <div class="kwp-col-4">
                            ...
                            {{ Form::text('latest_return', key_exists('latest_return', $request) ? $request['latest_return'] : null, ['class' => 'form-control box-size', 'placeholder' => trans('testmanuell::layer.general.latest_return'), 'required' => 'required']) }}
                        ...
                        <div class="kwp-col-12">
                            ...
                            <div class="kwp-custom-select">
                                {{ Form::select('duration', array_merge(['' => trans('testmanuell::layer.general.duration_empty')], $duration_arr), key_exists('duration', $request) ? $request['duration'] : null, ['class' => 'form-control box-size']) }}
                            </div>
            ...
            <div class="kwp-col-4 pax-col main-col">
                <div class="kwp-form-group pax-group">
                    ...
                    <div class="pax-more">
                        <div class="kwp-col-12">
                            {{ Form::label('adults', trans('testmanuell::layer.general.adults'), ['class' => 'control-label required']) }}
                            <div class="kwp-custom-select">
                        ...
                        <div class="kwp-col-12 kids" style="position: relative;">
                            <div class="kwp-col-12">
                                {{ Form::label('kids', trans('testmanuell::layer.general.kids'), ['class' => 'control-label required']) }}
                                <div class="kwp-custom-select">
        ...
        <div class="kwp-row">
            <div class="kwp-col-3 rangeslider-wrapper">
                <div class="kwp-form-group ">
                    {{ Form::label('budget', trans('testmanuell::layer.general.budget'), ['class' => 'control-label required']) }}
                    {{ Form::number('budget', key_exists('budget', $request) ? $request['budget'] : null, ['class' => 'form-control box-size hidden', 'placeholder' => trans('testmanuell::layer.placeholder.budget'), 'required' => 'required']) }}
                </div>
            ...
            <div class="kwp-col-3 white-col stars">
                <div class="kwp-form-group">
                    {{ Form::label('category', trans('testmanuell::layer.general.category'), ['class' => 'control-label required']) }}
                    {{ Form::number('category', key_exists('category', $request) ? $request['category'] : null, ['class' => 'form-control box-size hidden', 'placeholder' => trans('testmanuell::layer.placeholder.category')]) }}
            ...
            <div class="kwp-col-3 white-col catering">
                {{ Form::label('catering', trans('testmanuell::layer.general.catering'), ['class' => 'control-label required']) }}
        ...
        <div class="kwp-row">
            <div class="kwp-col-12 description">
                {{ Form::label('description', trans('testmanuell::layer.general.description'), ['class' => 'control-label required']) }}
                {{ Form::textarea('description', key_exists('description', $request) ? $request['description'] : null,['class' => 'form-control', 'placeholder' => trans('testmanuell::layer.placeholder.description')]) }}
                <i class="master-icon--calendar-month"></i>
            </div>
        </div>
        ...
        <div class="kwp-row">
            <div class="kwp-col-4 email-col">
                {{ Form::label('email', trans('testmanuell::layer.general.email'), ['class' => 'control-label']) }}
                {{ Form::text('email', key_exists('email', $request) ? $request['email'] : null, ['class' => 'form-control box-size', 'placeholder' => trans('testmanuell::layer.placeholder.email'), 'required' => 'required']) }}
