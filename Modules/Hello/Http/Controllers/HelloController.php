...
use Modules\Hello\Http\Requests\StoreWishRequest;
...
class HelloController extends Controller
{
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Hello');

        return view('hello::index')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('hello::layer.created')->with([
