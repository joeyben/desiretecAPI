<!--Action Button-->
    @if(Active::checkUriPattern('admin/distributions'))
        <div class="btn-group">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.distributions.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.distributions.all')}}</a></li>
    @permission('create-blog')
    <li><a href="{{route('admin.distributions.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.distributions.create')}}</a></li>
    @endauth
  </ul>
</div>
