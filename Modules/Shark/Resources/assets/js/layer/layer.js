...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'http://shark.com',
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/shark/css/layer/whitelabel.css'
    };
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        name: 'TUI IBE',
        matchesUrl: 'www.shark.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
    ...
    //    matchesUrl: 'shark.com/pauschalreisen',
    ...
    $(document).ready(function (e) {
        ...
        dt.Tracking.init('shark_exitwindow','UA-105970361-1');
    ...
    dt.agbModal = function (e) {
        ...
        function show() {
            ...
            /*$.ajax({
                url: 'http://shark-reisewunsch.com/bundles/csshark/popup/static/agb.html',
                type: 'GET',
                crossDomain: true,
                dataType: 'jsonp',
