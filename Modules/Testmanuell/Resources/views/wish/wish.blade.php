...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/testmanuell/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/testmanuell/css/testmanuell.css') }}">
@endsection
...
@section('footer')
    @include('testmanuell::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/testmanuell/js/testmanuell.js') }}"></script>
@endsection
