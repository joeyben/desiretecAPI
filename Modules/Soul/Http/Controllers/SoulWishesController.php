...
namespace Modules\Soul\Http\Controllers;
...
/**
 * Class SoulWishesController.
 */
class SoulWishesController extends Controller
{
    ...
    public function __construct(WishesRepository $wish, WhitelabelsRepository $whitelabel, CategoriesRepository $categories)
    {
        ...
        $this->whitelabelId = \Config::get('soul.id');
    ...
    public function view(Wish $wish)
    {
        ...
        return view('soul::wish.wish')->with([
            'wish'               => $wish,
            'avatar'             => $avatar,
    ...
    public function validateTokenList($token)
    {
        ...
        if ($this->wish->validateToken($token)) {
            if (Route::has('soul.list')) {
                return redirect()->route('soul.list');
            }
        }
    ...
    {
        //var_dump($request->ip());
        return view('soul::wish.index')->with([
            'status'     => $this->status,
