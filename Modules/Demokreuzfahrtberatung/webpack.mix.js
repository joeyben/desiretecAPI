...
mix.scripts(
    ...
    .sass(base_url + '/resources/assets/sass/layer/_datepicker.scss', 'whitelabel/demokreuzfahrtberatung/css/datepicker.css')
    .sass(__dirname + '/Resources/assets/sass/app.scss', 'whitelabel/demokreuzfahrtberatung/css/demokreuzfahrtberatung.css')
    .styles([
        base_url + '/public/whitelabel/demokreuzfahrtberatung/css/datepicker.css',
        base_url + '/public/whitelabel/demokreuzfahrtberatung/css/layer/layer.css',
    ], __dirname + '/../../public/whitelabel/demokreuzfahrtberatung/css/layer/whitelabel.css')
    .styles([
        base_url + '/public/whitelabel/demokreuzfahrtberatung/css/datepicker.css',
        base_url + '/public/whitelabel/demokreuzfahrtberatung/css/layer/layer_mobile.css',
    ], __dirname + '/../../public/whitelabel/demokreuzfahrtberatung/css/layer/whitelabel_mobile.css')
    .copy(__dirname +'/Resources/assets/images/', __dirname +'/../../public/whitelabel/demokreuzfahrtberatung/images/')
    .copy(__dirname +'/Resources/assets/svg/', __dirname +'/../../public/whitelabel/demokreuzfahrtberatung/svg/');
if (mix.inProduction()) {
    mix.version();
}