...
/**
 * Class IndividualreisenWishesController.
 */
class IndividualreisenWishesController extends Controller
{
    ...
    public function view(Wish $wish)
    {
        ...
        return view('individualreisen::wish.wish')->with([
            'wish'                => $wish,
            'avatar'              => $avatar,
    ...
    public function validateTokenList($token)
    {
        if ($this->wish->validateToken($token)) {
            if (Route::has('individualreisen.list')) {
                return redirect()->route('individualreisen.list');
            }
        }
    ...
    {
        //var_dump($request->ip());
        return view('individualreisen::wish.index')->with([
            'status'     => $this->status,
