...
use Modules\Dolphin\Http\Requests\StoreWishRequest;
...
class DolphinController extends Controller
{
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Dolphin');

        return view('dolphin::index')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('dolphin::layer.created')->with([
