...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/reisexperten/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/reisexperten/css/reisexperten.css') }}">
@endsection
...
@section('footer')
    @include('reisexperten::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/reisexperten/js/reisexperten.js') }}"></script>
@endsection
