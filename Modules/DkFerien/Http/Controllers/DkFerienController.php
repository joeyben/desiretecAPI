...
namespace Modules\DkFerien\Http\Controllers;
...
use Modules\DkFerien\Http\Requests\StoreWishRequest;

class DkFerienController extends Controller
{
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('dkferien.id');
    ...
    {
        return view('dkferien::index')->with([
    ...
    {
        $html = view('dkferien::layer.popup')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('dkferien::layer.created')->with([
    ...
    {
        return view('dkferien::layer.pdf');
    }
}
