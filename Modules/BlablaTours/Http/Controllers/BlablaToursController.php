...
namespace Modules\BlablaTours\Http\Controllers;
...
use Modules\BlablaTours\Http\Requests\StoreWishRequest;

class BlablaToursController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('blablatours.id');
    }
    ...
    {
        $whitelabel = $this->whitelabel->getByName('BlablaTours');

        return view('blablatours::index')->with([
    ...
    {
        $html = view('blablatours::layer.popup')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('blablatours::layer.created')->with([
