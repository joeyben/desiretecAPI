...
class CloneLanguageLinesNotification extends Notification
{
    use Queueable;
    ...
    {
        createNotification('Languages has been successfully cloned: ' . $this->count . ' by <strong>' . Auth::guard('web')->user()->first_name . ' ' . Auth::guard('web')->user()->last_name . '</strong>', $notifiable->id, Auth::guard('web')->user()->id);
