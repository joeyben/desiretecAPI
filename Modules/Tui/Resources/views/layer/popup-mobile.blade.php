        ...
        <div class="kwp-row">
            ...
            <div class="kwp-col-4 white-col stars">
                    <div class="kwp-form-group">
                             ...
                             {{ Form::number('category', key_exists('category', $request) ? $request['category'] : null, ['class' => 'form-control box-size hidden', 'placeholder' => trans('tui::layer.placeholder.category')]) }}
                ...
                <div class="kwp-row">
                    ...
                    <div class="kwp-col-4 white-col">
                        <div class="kwp-agb">
                            ...
                            <p>Ich habe die <a id="datenschutz" href="https://www.tui.com/datenschutz-hinweis/" target="_blank">Datenschutzrichtlinien</a> zur Kenntnis genommen und möchte meinen Reisewunsch absenden.</p>
