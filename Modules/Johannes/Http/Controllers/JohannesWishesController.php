...
/**
 * Class JohannesWishesController.
 */
class JohannesWishesController extends Controller
{
    ...
    public function __construct(WishesRepository $wish, WhitelabelsRepository $whitelabel, CategoriesRepository $categories)
    {
        ...
        $this->whitelabelId = \Config::get('$MODULESMAL$.id');
    ...
    public function view(Wish $wish)
    {
        ...
        return view('$MODULESMAL$::wish.wish')->with([
            'wish'               => $wish,
            'avatar'             => $avatar,
    ...
    {
        //var_dump($request->ip());
        return view('$MODULESMAL$::wish.index')->with([
            'status'     => $this->status,
