...
use Modules\Squad\Http\Requests\StoreWishRequest;
...
class SquadController extends Controller
{
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Squad');

        return view('squad::index')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('squad::layer.created')->with([
