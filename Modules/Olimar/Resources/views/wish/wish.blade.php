...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/olimar/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/olimar/css/olimar.css') }}">
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/olimar/js/olimar.js') }}"></script>
@endsection
