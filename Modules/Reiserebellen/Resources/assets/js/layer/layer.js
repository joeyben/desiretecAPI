...
(function ($) {
    ...
    var MasterIBETripDataDecoderMobile = $.extend({}, dt.AbstractTripDataDecoder, {
        name: 'Reiserebellen Rundreisen Mobile',
        matchesUrl: 'm.reiserebellen.com/(buchen)',
        dictionaries: {
            'catering': {
                'AI': 'all-inclusive',
                'AP': 'all-inclusive',
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        name: 'Reiserebellen IBE',
        matchesUrl: 'www.reiserebellen.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
