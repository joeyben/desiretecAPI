    ...
    <div class="kwp-content kwp-with-expansion">
        ...
        <div class="kwp-row">
            <div class="kwp-col-3 rangeslider-wrapper">
                <div class="kwp-form-group ">
                    {{ Form::label('budget', trans('bild::layer.general.budget'), ['class' => 'control-label required']) }}
            ...
            <div class="kwp-col-3 white-col stars">
                <div class="kwp-form-group">
                    {{ Form::label('category', trans('bild::layer.general.category'), ['class' => 'control-label required']) }}
            ...
            <div class="kwp-col-3 white-col catering">
                {{ Form::label('catering', trans('bild::layer.general.catering'), ['class' => 'control-label required']) }}
                <div class="kwp-custom-select">
        ...
        <div class="kwp-row">
            <div class="kwp-col-12 white-col footer-col">
                <div class="kwp-agb">
                    ...
                    <p>Ich habe die <a href="https://bild.reisewunschservice.de/tnb" id="agb_link" target="_blank">Teilnahmebedingungen</a> und <a id="datenschutz" href="https://reisen.bild.de/datenschutz/" target="_blank">Datenschutzrichtlinien</a> zur Kenntnis genommen und möchte meinen Reisewunsch absenden.</p>
                    @if ($errors->any() && $errors->get('terms'))
