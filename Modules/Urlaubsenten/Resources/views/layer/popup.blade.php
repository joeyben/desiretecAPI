    ...
    <div class="kwp-content kwp-with-expansion">
        <div class="kwp-row">
            <div class="kwp-col-4 destination">
                ...
                {{ Form::text('destination', key_exists('destination', $request) ? $request['destination'] : null, ['class' => 'form-control box-size','autocomplete' => "off", 'placeholder' => trans('urlaubsenten::layer.placeholder.destination'), 'required' => 'required']) }}
            ...
            <div class="kwp-col-4">
                ...
                {{ Form::text('airport', key_exists('airport', $request) ? $request['airport'] : null, ['class' => 'form-control box-size','autocomplete' => "off", 'placeholder' => trans('urlaubsenten::layer.placeholder.airport'), 'required' => 'required']) }}
                    ...
                    <div class="duration-more">
                        ...
                        <div class="kwp-col-12">
                            ...
                            <div class="kwp-custom-select">
                                {{ Form::select('duration', array_merge(['0' => trans('urlaubsenten::layer.general.duration_empty')], $duration_arr), key_exists('duration', $request) ? $request['duration'] : null, ['class' => 'form-control box-size']) }}
                            </div>
        ...
        <div class="kwp-row">
            <div class="kwp-col-3 rangeslider-wrapper">
                <div class="kwp-form-group ">
                    {{ Form::label('budget', trans('urlaubsenten::layer.general.budget'), ['class' => 'control-label required']) }}
            ...
            <div class="kwp-col-3 white-col stars">
                <div class="kwp-form-group">
                    {{ Form::label('category', trans('urlaubsenten::layer.general.category'), ['class' => 'control-label required']) }}
            ...
            <div class="kwp-col-3 white-col catering">
                {{ Form::label('catering', trans('urlaubsenten::layer.general.catering'), ['class' => 'control-label required']) }}
                <div class="kwp-custom-select">
        ...
        <div class="kwp-row">
            <div class="kwp-col-12 description">
                {{ Form::label('description', trans('urlaubsenten::layer.general.description'), ['class' => 'control-label required']) }}
        ...
        <div class="kwp-row">
            <div class="kwp-col-4 email-col">
                {{ Form::label('email', trans('urlaubsenten::layer.general.email'), ['class' => 'control-label']) }}
                {{ Form::text('email', key_exists('email', $request) ? $request['email'] : null, ['class' => 'form-control box-size', 'placeholder' => trans('urlaubsenten::layer.placeholder.email'), 'required' => 'required']) }}
