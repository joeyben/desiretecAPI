...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/wale/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/wale/css/wale.css') }}">
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/wale/js/wale.js') }}"></script>
@endsection
