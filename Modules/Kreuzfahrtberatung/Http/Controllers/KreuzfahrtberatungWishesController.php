...
/**
 * Class KreuzfahrtberatungWishesController.
 */
class KreuzfahrtberatungWishesController extends Controller
{
    ...
    public function view(Wish $wish)
    {
        ...
        return view('kreuzfahrtberatung::wish.wish')->with([
            'wish'               => $wish,
            'avatar'             => $avatar,
    ...
    public function validateTokenList($token)
    {
        ...
        if ($this->wish->validateToken($token)) {
            if (Route::has('kreuzfahrtberatung.list')) {
                return redirect()->route('kreuzfahrtberatung.list');
            }
        }
