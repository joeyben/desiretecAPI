<template>
    <div class="list-icons">
        <router-link class="btn btn-outline btn-sm bg-teal text-teal-800 btn-icon ml-2" :to="{name: 'root.seller', params: { id: rowData.id }}"  v-if="can_edit && hasRole('Executive')" data-popup="tooltip" :title="trans('button.edit')"><i class="icon-pencil"></i></router-link>
