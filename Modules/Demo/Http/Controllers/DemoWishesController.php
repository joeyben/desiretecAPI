...
/**
 * Class DemoWishesController.
 */
class DemoWishesController extends Controller
{
    ...
    public function __construct(WishesRepository $wish, WhitelabelsRepository $whitelabel, CategoriesRepository $categories)
    {
        ...
        $this->whitelabelId = \Config::get('demo.id');
    ...
    public function view(Wish $wish)
    {
        ...
        return view('demo::wish.wish')->with([
            'wish'                => $wish,
            'avatar'              => $avatar,
    ...
    {
        //var_dump($request->ip());
        return view('demo::wish.index')->with([
            'status'     => $this->status,
