...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/demomanuell/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/demomanuell/css/demomanuell.css') }}">
@endsection
...
@section('footer')
    @include('demomanuell::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/demomanuell/js/demomanuell.js') }}"></script>
@endsection
