...
use Modules\FN\Http\Requests\StoreWishRequest;
...
class FNController extends Controller
{
    ...
    {
        $whitelabel = $this->whitelabel->getByName('FN');

        return view('fn::index')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('fn::layer.created')->with([
