...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'http://testmanuell.com',
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/testmanuell/css/layer/whitelabel.css'
    };
    ...
    var MasterIBETripDataDecoderMobile = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        matchesUrl: 'm.testmanuell.com/(buchen)',
        dictionaries: {
            'catering': {
                'AI': 'all-inclusive',
                'AP': 'all-inclusive',
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        name: 'TUI IBE',
        matchesUrl: 'www.testmanuell.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
    ...
    //    matchesUrl: 'testmanuell.com/pauschalreisen',
