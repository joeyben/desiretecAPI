...
namespace Modules\Demomanuell\Http\Controllers;
...
use Modules\Demomanuell\Http\Requests\StoreWishRequest;

class DemomanuellController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('demomanuell.id');
    }
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Demomanuell');

        return view('demomanuell::index')->with([
    ...
    public function show(Request $request)
    {
        ...
        $html = view('demomanuell::' . $layer)->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('demomanuell::layer.created')->with([
