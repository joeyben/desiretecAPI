...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/adventure/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/adventure/css/adventure.css') }}">
@endsection
...
@section('footer')
    @include('adventure::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/adventure/js/adventure.js') }}"></script>
@endsection
