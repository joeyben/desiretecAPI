...
namespace Modules\Lummerland\Http\Controllers;
...
use Modules\Lummerland\Http\Requests\StoreWishRequest;

class LummerlandController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('lummerland.id');
    }
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Lummerland');

        return view('lummerland::index')->with([
    ...
    public function show(Request $request)
    {
        ...
        $html = view('lummerland::' . $layer)->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('lummerland::layer.created')->with([
