    ...
    <script>
      $(function() {
        ...
        $('#associated_permissions').change(function(){
          var associatedPermission = $(this).val();
          if (associatedPermission === 'all') {
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div id="available-permissions" class="hidden mt-20" style="width: 700px; height: 200px; overflow-x: hidden; overflow-y: scroll; {{ $role->all ? 'display: none;': 'display: block;' }}">
                            <div class="form-group">
                                <div class="col-xs-12">
