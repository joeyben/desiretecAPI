...
use Modules\Soul\Http\Requests\StoreWishRequest;
...
class SoulController extends Controller
{
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Soul');

        return view('soul::index')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('soul::layer.created')->with([
