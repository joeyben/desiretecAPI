...
let $footersComponent = document.querySelector('#footersComponent')
...
if ($footersComponent) {
  const router = new VueRouter({
    routes: [{
      path: '/',
      name: 'root',
      component: require('./components/FootersComponent.vue'),
      children: [{
        path: '/edit/:id(\\d+)',
        name: 'root.edit',
        component: require('./components/EditFooterComponent.vue')
      }, {
