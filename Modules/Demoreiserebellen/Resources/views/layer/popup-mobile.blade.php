{{ Form::open(['route' => 'demoreiserebellen.store' , 'method' => 'get', 'class' => '', 'role' => 'form', 'files' => true]) }}
            ...
            <div class="kwp-col-4 duration-col main-col">
                <div class="kwp-form-group duration-group">
                    ...
                    <div class="duration-more">
                        <div class="kwp-col-4">
                            {{ Form::label('earliest_start', trans('demoreiserebellen::layer.general.earliest_start'), ['class' => 'control-label required']) }}
                        ...
                        <div class="kwp-col-4">
                            {{ Form::label('latest_return', trans('demoreiserebellen::layer.general.latest_return'), ['class' => 'control-label required']) }}
                        ...
                        <div class="kwp-col-12">
                            {{ Form::label('duration', trans('demoreiserebellen::layer.general.duration'), ['class' => 'control-label required']) }}
