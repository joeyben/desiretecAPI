  ...
  export default {
    ...
    methods: {
      ...
      handleClose (tag) {
        ...
        this.$http.delete(window.laroute.route('provider.hosts.destroy', {host: encodeURIComponent(tag), id: this.whitelebelId}))
      ...
      handleInputConfirm () {
        ...
        if (inputValue) {
          this.$store.dispatch('block', {element: 'whitelabelsProviderComponent', load: true})
          this.$http.post(window.laroute.route('provider.hosts.store'), {host: 'https://' + inputValue, whitelebelId: this.whitelebelId, layerId: this.layerId})
