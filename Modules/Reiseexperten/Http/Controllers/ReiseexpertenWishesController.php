...
namespace Modules\Reiseexperten\Http\Controllers;
...
/**
 * Class ReiseexpertenWishesController.
 */
class ReiseexpertenWishesController extends Controller
{
    ...
    public function view(Wish $wish)
    {
        ...
        return view('reiseexperten::wish.wish')->with([
            'wish'               => $wish,
            'avatar'             => $avatar,
