...
/**
 * Class ReisExpertenWishesController.
 */
class ReisExpertenWishesController extends Controller
{
    ...
    public function view(Wish $wish)
    {
        ...
        return view('reisexperten::wish.wish')->with([
            'wish'               => $wish,
            'avatar'             => $avatar,
    ...
    public function validateTokenList($token)
    {
        ...
        if ($this->wish->validateToken($token)) {
            if (Route::has('reisexperten.list')) {
                return redirect()->route('reisexperten.list');
            }
        }
    ...
    {
        //var_dump($request->ip());
        return view('reisexperten::wish.index')->with([
            'status'     => $this->status,
