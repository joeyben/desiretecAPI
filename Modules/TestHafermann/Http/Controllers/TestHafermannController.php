...
namespace Modules\TestHafermann\Http\Controllers;
...
use Modules\TestHafermann\Http\Requests\StoreWishRequest;

class TestHafermannController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('testhafermann.id');
    }
    ...
    {
        $whitelabel = $this->whitelabel->getByName('TestHafermann');

        return view('testhafermann::index')->with([
    ...
    public function show(Request $request)
    {
        ...
        $html = view('testhafermann::'.$layer)->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('testhafermann::layer.created')->with([
