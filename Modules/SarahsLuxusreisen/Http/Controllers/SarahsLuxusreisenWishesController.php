...
/**
 * Class SarahsLuxusreisenWishesController.
 */
class SarahsLuxusreisenWishesController extends Controller
{
    ...
    public function view(Wish $wish)
    {
        ...
        return view('sarahsluxusreisen::wish.wish')->with([
            'wish'                => $wish,
            'avatar'              => $avatar,
    ...
    public function validateTokenList($token)
    {
        if ($this->wish->validateToken($token)) {
            if (Route::has('sarahsluxusreisen.list')) {
                return redirect()->route('sarahsluxusreisen.list');
            }
        }
    ...
    {
        //var_dump($request->ip());
        return view('sarahsluxusreisen::wish.index')->with([
            'status'     => $this->status,
