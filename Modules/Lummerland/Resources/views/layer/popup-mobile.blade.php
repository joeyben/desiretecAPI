{{ Form::open(['route' => 'lummerland.store' , 'method' => 'get', 'class' => '', 'role' => 'form', 'files' => true]) }}
            ...
            <div class="kwp-col-4 duration-col main-col">
                <div class="kwp-form-group duration-group">
                    ...
                    <div class="duration-more">
                        <div class="kwp-col-4">
                            {{ Form::label('earliest_start', trans('lummerland::layer.general.earliest_start'), ['class' => 'control-label required']) }}
                        ...
                        <div class="kwp-col-4">
                            {{ Form::label('latest_return', trans('lummerland::layer.general.latest_return'), ['class' => 'control-label required']) }}
                        ...
                        <div class="kwp-col-12">
                            {{ Form::label('duration', trans('lummerland::layer.general.duration'), ['class' => 'control-label required']) }}
