...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/urlaub/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/urlaub/css/urlaub.css') }}">
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/urlaub/js/urlaub.js') }}"></script>
@endsection
