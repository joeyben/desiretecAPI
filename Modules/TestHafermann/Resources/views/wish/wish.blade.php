...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/testhafermann/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/testhafermann/css/testhafermann.css') }}">
@endsection
...
@section('footer')
    @include('testhafermann::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/testhafermann/js/testhafermann.js') }}"></script>
@endsection
