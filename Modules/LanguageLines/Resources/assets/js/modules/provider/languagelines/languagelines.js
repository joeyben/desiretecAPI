...
let $languageLinesComponent = document.querySelector('#languageLinesComponent')

if ($languageLinesComponent) {
  const router = new VueRouter({
    routes: [{
      path: '/',
      name: 'root',
      component: require('./components/LanguageLinesComponent.vue'),
      children: [{
        path: '/edit/:id(\\d+)',
        name: 'root.edit',
