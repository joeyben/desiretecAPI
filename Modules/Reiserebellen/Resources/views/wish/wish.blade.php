...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/reiserebellen/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/reiserebellen/css/reiserebellen.css') }}">
@endsection
...
@section('footer')
    @include('reiserebellen::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/reiserebellen/js/reiserebellen.js') }}"></script>
@endsection
