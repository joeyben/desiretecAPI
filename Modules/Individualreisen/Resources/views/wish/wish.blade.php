...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/individualreisen/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/individualreisen/css/individualreisen.css') }}">
@endsection
...
@section('footer')
    @include('individualreisen::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/individualreisen/js/individualreisen.js') }}"></script>
@endsection
