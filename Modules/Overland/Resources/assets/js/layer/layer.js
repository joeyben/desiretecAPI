...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'http://overland.com',
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/overland/css/layer/whitelabel.css'
    };
    ...
    var MasterIBETripDataDecoderMobile = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        matchesUrl: 'm.overland.com/(buchen)',
        dictionaries: {
            'catering': {
                'AI': 'all-inclusive',
                'AP': 'all-inclusive',
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        name: 'TUI IBE',
        matchesUrl: 'www.overland.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
    ...
    //    matchesUrl: 'overland.com/pauschalreisen',
    ...
    $(document).ready(function (e) {
        ...
        dt.Tracking.init('overland_exitwindow','UA-105970361-1');
    ...
    dt.agbModal = function (e) {
        ...
        function show() {
            ...
            /*$.ajax({
                url: 'http://overland-reisewunsch.com/bundles/csoverland/popup/static/agb.html',
                type: 'GET',
                crossDomain: true,
                dataType: 'jsonp',
