...
/**
 * Class DemomanuellWishesController.
 */
class DemomanuellWishesController extends Controller
{
    ...
    public function view(Wish $wish)
    {
        ...
        return view('demomanuell::wish.wish')->with([
            'wish'               => $wish,
            'avatar'             => $avatar,
    ...
    public function validateTokenList($token)
    {
        ...
        if ($this->wish->validateToken($token)) {
            if (Route::has('demomanuell.list')) {
                return redirect()->route('demomanuell.list');
            }
        }
    ...
    {
        //var_dump($request->ip());
        return view('demomanuell::wish.index')->with([
            'status'     => $this->status,
