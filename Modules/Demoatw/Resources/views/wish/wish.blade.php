...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/demoatw/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/demoatw/css/demoatw.css') }}">
@endsection
...
@section('footer')
    @include('demoatw::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/demoatw/js/demoatw.js') }}"></script>
@endsection
