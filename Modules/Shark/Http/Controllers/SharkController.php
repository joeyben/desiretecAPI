...
use Modules\Shark\Http\Requests\StoreWishRequest;
...
class SharkController extends Controller
{
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Shark');

        return view('shark::index')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('shark::layer.created')->with([
