...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/name/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/name/css/name.css') }}">
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/name/js/name.js') }}"></script>
@endsection
