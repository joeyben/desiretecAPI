...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/strand/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/strand/css/strand.css') }}">
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/strand/js/strand.js') }}"></script>
@endsection
