...
{{ Form::open(['route' => 'bentour.store' , 'method' => 'get', 'class' => '', 'role' => 'form', 'files' => true]) }}
            ...
            <div class="kwp-col-4 duration-col main-col">
                <div class="kwp-form-group duration-group">
                    ...
                    <div class="duration-more">
                        <div class="kwp-col-4">
                            {{ Form::label('earliest_start', trans('bentour::layer.general.earliest_start'), ['class' => 'control-label required']) }}
                        ...
                        <div class="kwp-col-4">
                            {{ Form::label('latest_return', trans('bentour::layer.general.latest_return'), ['class' => 'control-label required']) }}
                        ...
                        <div class="kwp-col-12">
                            {{ Form::label('duration', trans('bentour::layer.general.duration'), ['class' => 'control-label required']) }}
                            <div class="kwp-custom-select">
                                {{ Form::select('duration', array_merge(['' => trans('bentour::layer.general.duration_empty')], $duration_arr), key_exists('duration', $request) ? $request['duration'] : null, ['class' => 'form-control box-size']) }}
                            </div>
