...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/reiseexperten/css/wish/details.css') }}">
...
@section('footer')
    @include('reiseexperten::layouts.footer')
@endsection
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-4 modal-body-right">
                        ...
                        <div class="modal-contact">
                            ...
                            <div class="mc-mail">
                                <span class="glyphicon glyphicon-envelope"></span>
                                <a href="@if(count($wish->group->users[0]->agents)){{ $wish->group->users[0]->agents[0]->email }}@endif">@if(count($wish->group->users[0]->agents)){{ $wish->group->users[0]->agents[0]->email }}@endif</a>
                            </div>
                        </div>
                    </div>
