...
/**
 * Class ReiserebellenWishesController.
 */
class ReiserebellenWishesController extends Controller
{
    ...
    public function list(Wish $wish)
    {
        ...
        return view('reiserebellen::list', compact('wish', 'offers', 'body_class'));
    }
    ...
    public function view(Wish $wish)
    {
        ...
        return view('reiserebellen::wish.wish')->with([
            'wish'               => $wish,
            'avatar'             => $avatar,
    ...
    public function validateTokenList($token)
    {
        if ($this->wish->validateToken($token)) {
            if (Route::has('reiserebellen.list')) {
                return redirect()->route('reiserebellen.list');
            }
        }
    ...
    public function wishList(ManageWishesRequest $request)
    {
        ...
        return view('reiserebellen::wish.index')->with([
            'status'     => $this->status,
