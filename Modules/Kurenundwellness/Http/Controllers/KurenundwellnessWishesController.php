...
/**
 * Class KurenundwellnessWishesController.
 */
class KurenundwellnessWishesController extends Controller
{
    ...
    public function view(Wish $wish)
    {
        ...
        return view('kurenundwellness::wish.wish')->with([
            'wish'               => $wish,
            'avatar'             => $avatar,
    ...
    public function validateTokenList($token)
    {
        ...
        if ($this->wish->validateToken($token)) {
            if (Route::has('kurenundwellness.list')) {
                return redirect()->route('kurenundwellness.list');
            }
        }
    ...
    public function wishList(ManageWishesRequest $request)
    {
        ...
        return view('kurenundwellness::wish.index')->with([
            'status'     => $this->status,
