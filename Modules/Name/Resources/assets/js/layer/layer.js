...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'http://name.com',
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/name/css/layer/whitelabel.css'
    };
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        name: 'TUI IBE',
        matchesUrl: 'www.name.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
    ...
    //    matchesUrl: 'name.com/pauschalreisen',
    ...
    $(document).ready(function (e) {
        ...
        dt.Tracking.init('name_exitwindow','UA-105970361-1');
    ...
    dt.agbModal = function (e) {
        ...
        function show() {
            ...
            /*$.ajax({
                url: 'http://name-reisewunsch.com/bundles/csname/popup/static/agb.html',
                type: 'GET',
                crossDomain: true,
                dataType: 'jsonp',
