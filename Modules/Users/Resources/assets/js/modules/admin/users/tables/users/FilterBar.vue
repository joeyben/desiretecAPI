    ...
    <div class="card-header header-elements-inline">
        <h5 class="card-title">
            ...
            <div class="dropdown-menu dropdown-menu-left">
                <a :href="createLink" class="dropdown-item" v-if="hasPermissionTo('Administrator')"><i class="icon-plus3"></i>  {{ trans('button.create') }}</a>
                <router-link class="dropdown-item" :to="{name: 'root.create.seller', params: { id: 0 }}"  v-if="hasRole('Executive')"><i class="icon-plus2"></i>{{ trans('button.create') }}</router-link>
            </div>
        </h5>
