...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/testauto/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/testauto/css/testauto.css') }}">
@endsection
...
@section('footer')
    @include('testauto::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/testauto/js/testauto.js') }}"></script>
@endsection
