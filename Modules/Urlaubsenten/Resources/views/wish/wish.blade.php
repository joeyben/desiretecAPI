...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/urlaubsenten/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/urlaubsenten/css/urlaubsenten.css') }}">
@endsection
...
@section('footer')
    @include('urlaubsenten::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/urlaubsenten/js/urlaubsenten.js') }}"></script>
@endsection
