...
namespace Modules\SarahsLuxusreisen\Http\Controllers;
...
use Modules\SarahsLuxusreisen\Http\Requests\StoreWishRequest;

class SarahsLuxusreisenController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('sarahsluxusreisen.id');
    }
    ...
    {
        $whitelabel = $this->whitelabel->getByName('SarahsLuxusreisen');

        return view('sarahsluxusreisen::index')->with([
    ...
    public function show(Request $request)
    {
        ...
        $html = view('sarahsluxusreisen::'.$layer)->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('sarahsluxusreisen::layer.created')->with([
