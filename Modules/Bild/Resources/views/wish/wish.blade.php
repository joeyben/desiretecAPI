...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/bild/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/bild/css/bild.css') }}">
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/bild/js/bild.js') }}"></script>
@endsection
