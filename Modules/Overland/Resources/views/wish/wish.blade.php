...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/overland/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/overland/css/overland.css') }}">
@endsection
...
@section('footer')
    @include('overland::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/overland/js/overland.js') }}"></script>
@endsection
