...
namespace Modules\Kreuzfahrtberatung\Http\Controllers;
...
use Modules\Kreuzfahrtberatung\Http\Requests\StoreWishRequest;

class KreuzfahrtberatungController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('kreuzfahrtberatung.id');
    }
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Kreuzfahrtberatung');

        return view('kreuzfahrtberatung::index')->with([
    ...
    public function show(Request $request)
    {
        ...
        $html = view('kreuzfahrtberatung::'.$layer)->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('kreuzfahrtberatung::layer.created')->with([
