...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'http://dolphin.com',
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/dolphin/css/layer/whitelabel.css'
    };
    ...
    var MasterIBETripDataDecoderMobile = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        matchesUrl: 'm.dolphin.com/(buchen)',
        dictionaries: {
            'catering': {
                'AI': 'all-inclusive',
                'AP': 'all-inclusive',
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        name: 'TUI IBE',
        matchesUrl: 'www.dolphin.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
    ...
    //    matchesUrl: 'dolphin.com/pauschalreisen',
    ...
    $(document).ready(function (e) {
        ...
        dt.Tracking.init('dolphin_exitwindow','UA-105970361-1');
    ...
    dt.agbModal = function (e) {
        ...
        function show() {
            ...
            /*$.ajax({
                url: 'http://dolphin-reisewunsch.com/bundles/csdolphin/popup/static/agb.html',
                type: 'GET',
                crossDomain: true,
                dataType: 'jsonp',
