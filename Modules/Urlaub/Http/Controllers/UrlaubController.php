...
namespace Modules\Urlaub\Http\Controllers;
...
use Modules\Urlaub\Http\Requests\StoreWishRequest;
...
class UrlaubController extends Controller
{
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('urlaub.id');
    }
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Urlaub');

        return view('urlaub::index')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('urlaub::layer.created')->with([
