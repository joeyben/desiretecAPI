...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'https://traveloverland.com',
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/traveloverland/css/layer/whitelabel.css'
    };
    ...
    /**** Mobile Decoder ****/
        var MasterIBETripDataDecoderMobile = $.extend({}, dt.AbstractTripDataDecoder, {
            ...
            matchesUrl: 'm.traveloverland.com/(buchen)',
            dictionaries: {
                'catering': {
                    'AI': 'all-inclusive',
                    'AP': 'all-inclusive',
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
            ...
            name: 'TUI IBE',
            matchesUrl: 'www.traveloverland.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
    ...
    //    matchesUrl: 'traveloverland.com/pauschalreisen',
