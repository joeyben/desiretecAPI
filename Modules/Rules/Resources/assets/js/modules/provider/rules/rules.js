...
let $rulesComponent = document.querySelector('#rulesComponent')
...
if ($rulesComponent) {
  const router = new VueRouter({
    routes: [{
      path: '/',
      name: 'root',
      component: require('./components/RulesComponent.vue'),
      children: [{
        path: '/edit/:id(\\d+)',
        name: 'root.edit',
        component: require('./components/EditRuleComponent.vue')
      }, {
