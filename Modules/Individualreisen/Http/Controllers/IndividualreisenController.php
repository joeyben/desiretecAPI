...
namespace Modules\Individualreisen\Http\Controllers;
...
use Modules\Individualreisen\Http\Requests\StoreWishRequest;

class IndividualreisenController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('individualreisen.id');
    }
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Individualreisen');

        return view('individualreisen::index')->with([
    ...
    public function show(Request $request)
    {
        ...
        $html = view('individualreisen::' . $layer)->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('individualreisen::layer.created')->with([
