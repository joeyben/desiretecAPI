<!--Action Button-->
    @if(Active::checkUriPattern('admin/wishes'))
        <div class="btn-group">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.wishes.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.wishes.all')}}</a></li>
    @permission('create-blog')
    <li><a href="{{route('admin.wishes.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.wishes.create')}}</a></li>
    @endauth
  </ul>
</div>
