...
/**
 * Class LummerlandWishesController.
 */
class LummerlandWishesController extends Controller
{
    ...
    public function view(Wish $wish)
    {
        ...
        return view('lummerland::wish.wish')->with([
            'wish'                => $wish,
            'avatar'              => $avatar,
    ...
    public function validateTokenList($token)
    {
        if ($this->wish->validateToken($token)) {
            if (Route::has('lummerland.list')) {
                return redirect()->route('lummerland.list');
            }
        }
    ...
    {
        //var_dump($request->ip());
        return view('lummerland::wish.index')->with([
            'status'     => $this->status,
