...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'https://lummerland.com',
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/lummerland/css/layer/whitelabel.css'
    };
    ...
    /**** Mobile Decoder ****/
        var MasterIBETripDataDecoderMobile = $.extend({}, dt.AbstractTripDataDecoder, {
            ...
            matchesUrl: 'm.lummerland.com/(buchen)',
            dictionaries: {
                'catering': {
                    'AI': 'all-inclusive',
                    'AP': 'all-inclusive',
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
            ...
            name: 'TUI IBE',
            matchesUrl: 'www.lummerland.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
    ...
    //    matchesUrl: 'lummerland.com/pauschalreisen',
