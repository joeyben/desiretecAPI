...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/lummerland/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/lummerland/css/lummerland.css') }}">
@endsection
...
@section('footer')
    @include('lummerland::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/lummerland/js/lummerland.js') }}"></script>
@endsection
