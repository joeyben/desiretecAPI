...
use Modules\TestAuto\Http\Requests\StoreWishRequest;
...
class TestAutoController extends Controller
{
    ...
    {
        $whitelabel = $this->whitelabel->getByName('TestAuto');

        return view('testauto::index')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('testauto::layer.created')->with([
