...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'http://squad.com',
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/squad/css/layer/whitelabel.css'
    };
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        name: 'TUI IBE',
        matchesUrl: 'www.squad.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
    ...
    //    matchesUrl: 'squad.com/pauschalreisen',
    ...
    $(document).ready(function (e) {
        ...
        dt.Tracking.init('squad_exitwindow','UA-105970361-1');
    ...
    dt.agbModal = function (e) {
        ...
        function show() {
            ...
            /*$.ajax({
                url: 'http://squad-reisewunsch.com/bundles/cssquad/popup/static/agb.html',
                type: 'GET',
                crossDomain: true,
                dataType: 'jsonp',
