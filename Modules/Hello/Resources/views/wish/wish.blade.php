...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/hello/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/hello/css/hello.css') }}">
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/hello/js/hello.js') }}"></script>
@endsection
