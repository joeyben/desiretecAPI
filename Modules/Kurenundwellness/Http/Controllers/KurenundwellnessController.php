...
namespace Modules\Kurenundwellness\Http\Controllers;
...
use Modules\Kurenundwellness\Http\Requests\StoreWishRequest;

class KurenundwellnessController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('kurenundwellness.id');
    }
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Kurenundwellness');

        return view('kurenundwellness::index')->with([
    ...
    public function show(Request $request)
    {
        ...
        $html = view('kurenundwellness::'.$layer)->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('kurenundwellness::layer.created')->with([
