...
namespace Modules\Overland\Http\Controllers;
...
/**
 * Class OverlandWishesController.
 */
class OverlandWishesController extends Controller
{
    ...
    public function view(Wish $wish)
    {
        ...
        return view('overland::wish.wish')->with([
            'wish'               => $wish,
            'avatar'             => $avatar,
    ...
    public function validateTokenList($token)
    {
        ...
        if ($this->wish->validateToken($token)) {
            if (Route::has('overland.list')) {
                return redirect()->route('overland.list');
            }
        }
    ...
    {
        //var_dump($request->ip());
        return view('overland::wish.index')->with([
            'status'     => $this->status,
