...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/dkferien/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/dkferien/css/dkferien.css') }}">
@endsection
...
@section('footer')
    @include('dkferien::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/dkferien/js/dkferien.js') }}"></script>
@endsection
