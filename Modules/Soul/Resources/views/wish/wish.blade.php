...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/soul/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/soul/css/soul.css') }}">
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/soul/js/soul.js') }}"></script>
@endsection
