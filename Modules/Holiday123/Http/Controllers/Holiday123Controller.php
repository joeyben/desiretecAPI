...
namespace Modules\Holiday123\Http\Controllers;
...
use Modules\Holiday123\Http\Requests\StoreWishRequest;

class Holiday123Controller extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function __construct(WhitelabelsRepository $whitelabel, CategoriesRepository $categories, EloquentAttachmentsRepository $attachements)
    {
        ...
        $this->whitelabelId = \Config::get('holiday123.id');
    }
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Holiday123');

        return view('holiday123::index')->with([
    ...
    public function show(Request $request)
    {
        ...
        $html = view('holiday123::'.$layer)->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('holiday123::layer.created')->with([
    ...
    public function getPDF()
        {
            return view('holiday123::layer.pdf');
        }
}
