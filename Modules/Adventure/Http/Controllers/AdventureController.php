...
use Modules\Adventure\Http\Requests\StoreWishRequest;
...
class AdventureController extends Controller
{
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Adventure');

        return view('adventure::index')->with([
    ...
    public function show(Request $request)
    {
        ...
        $html = view('adventure::'.$layer)->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('adventure::layer.created')->with([
