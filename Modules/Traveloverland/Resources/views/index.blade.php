@extends('traveloverland::layouts.master')

@section('content')
    <div class="slider" style="background-image: url({{ $bg_image }})">
        <div class="welcome">
        {{ trans('whitelabel.frontend.welcome') }}
        <strong>{{ trans('whitelabel.frontend.name') }} {{ trans('whitelabel.frontend.wish_portal') }}</strong>
        </div>
...
@section('footer')
    @include('traveloverland::layouts.footer')
@endsection
