...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/dolphin/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/dolphin/css/dolphin.css') }}">
@endsection
...
@section('footer')
    @include('dolphin::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/dolphin/js/dolphin.js') }}"></script>
@endsection
