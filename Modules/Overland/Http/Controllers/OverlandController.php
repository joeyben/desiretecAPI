...
use Modules\Overland\Http\Requests\StoreWishRequest;
...
class OverlandController extends Controller
{
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Overland');

        return view('overland::index')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('overland::layer.created')->with([
