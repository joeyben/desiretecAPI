...
export default {
  ...
  data () {
    return {
      apiUrl: window.laroute.route('admin.footers.view'),
  ...
  methods: {
    ...
    onRestore (id) {
      this.$store.dispatch('block', {element: 'footersComponent', load: true})
      this.$http.put(window.laroute.route('admin.footers.restore', {id: id}))
    ...
    onForceDelete (id) {
      this.$store.dispatch('block', {element: 'footersComponent', load: true})
      this.$http.delete(window.laroute.route('admin.footers.forceDelete', {id: id}))
        .then(this.onDeleteSuccess)
        .catch(this.onFailed)
        .then(() => {
          this.$store.dispatch('block', {element: 'footersComponent', load: false})
    ...
    onDelete (id) {
      this.$store.dispatch('block', {element: 'footersComponent', load: true})
      this.$http.delete(window.laroute.route('admin.footers.destroy', {id: id}))
        .then(this.onDeleteSuccess)
        .catch(this.onFailed)
        .then(() => {
          this.$store.dispatch('block', {element: 'footersComponent', load: false})
