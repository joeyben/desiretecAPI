    ...
    <div class="kwp-content kwp-with-expansion">
        <div class="kwp-row">
            <div class="kwp-col-4 destination">
                ...
                {{ Form::text('destination', null, ['class' => 'form-control box-size','autocomplete' => "off", 'placeholder' => trans('reiseexperten::layer.placeholder.destination'), 'required' => 'required']) }}
                <i class="master-icon--location-fill"></i>
            </div>

            <div class="kwp-col-4">
                {{ Form::label('airport', trans('layer.general.airport'), ['class' => 'control-label required']) }}
                {{ Form::text('airport', null, ['class' => 'form-control box-size','autocomplete' => "off", 'placeholder' => trans('reiseexperten::layer.placeholder.airport'), 'required' => 'required']) }}
                ...
                <div class="kwp-form-group duration-group">
                    ...
                    <div class="duration-more">
                        <div class="kwp-col-4">
                            ...
                            {{ Form::text('earliest_start', null, ['class' => 'form-control box-size', 'placeholder' => trans('reiseexperten::layer.general.earliest_start'), 'required' => 'required']) }}
                        ...
                        <div class="kwp-col-4">
                            ...
                            {{ Form::text('latest_return', null, ['class' => 'form-control box-size', 'placeholder' => trans('reiseexperten::layer.general.latest_return'), 'required' => 'required']) }}
                        ...
                        <div class="kwp-col-12">
                            ...
                            <div class="kwp-custom-select">
                                {{ Form::select('duration', array_merge(['' => trans('reiseexperten::layer.general.duration_empty')], $duration_arr), ['class' => 'form-control box-size']) }}
                            </div>
        ...
        <div class="kwp-row">
            <div class="kwp-col-3 rangeslider-wrapper">
                <div class="kwp-form-group ">
                    ...
                    {{ Form::number('budget', old('budget'), ['class' => 'form-control box-size hidden', 'placeholder' => trans('reiseexperten::layer.placeholder.budget'), 'required' => 'required']) }}
                </div>
            ...
            <div class="kwp-col-3 white-col stars">
                <div class="kwp-form-group">
                    {{ Form::label('category', trans('reiseexperten::layer.general.category'), ['class' => 'control-label required']) }}
                    {{ Form::number('category', old('category'), ['class' => 'form-control box-size hidden', 'placeholder' => trans('reiseexperten::layer.placeholder.category')]) }}
        ...
        <div class="kwp-row">
            <div class="kwp-col-12 description">
                {{ Form::label('description', trans('reiseexperten::layer.general.description'), ['class' => 'control-label required']) }}
                {{ Form::textarea('description', null,['class' => 'form-control', 'placeholder' => trans('reiseexperten::layer.placeholder.description')]) }}
                <i class="master-icon--calendar-month"></i>
            </div>
        </div>
        ...
        <div class="kwp-row">
            <div class="kwp-col-4 email-col">
                {{ Form::label('email', trans('reiseexperten::layer.general.email'), ['class' => 'control-label']) }}
                {{ Form::text('email', null, ['class' => 'form-control box-size', 'placeholder' => trans('reiseexperten::layer.placeholder.email'), 'required' => 'required']) }}
