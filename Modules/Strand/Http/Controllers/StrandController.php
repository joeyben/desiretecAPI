...
use Modules\Strand\Http\Requests\StoreWishRequest;
...
class StrandController extends Controller
{
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Strand');

        return view('strand::index')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('strand::layer.created')->with([
