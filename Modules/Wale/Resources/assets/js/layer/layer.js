...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'http://wale.com',
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/wale/css/layer/whitelabel.css'
    };
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        name: 'TUI IBE',
        matchesUrl: 'www.wale.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
    ...
    //    matchesUrl: 'wale.com/pauschalreisen',
    ...
    $(document).ready(function (e) {
        ...
        dt.Tracking.init('wale_exitwindow','UA-105970361-1');
    ...
    dt.agbModal = function (e) {
        ...
        function show() {
            ...
            /*$.ajax({
                url: 'http://wale-reisewunsch.com/bundles/cswale/popup/static/agb.html',
                type: 'GET',
                crossDomain: true,
                dataType: 'jsonp',
