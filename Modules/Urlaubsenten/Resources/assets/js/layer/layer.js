...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'https://urlaubsenten.reise-wunsch.com',
        logoPath: '/whitelabel/urlaubsenten/images/layer/logo.png',
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/urlaubsenten/css/layer/whitelabel.css'
    };
    ...
    var MasterIBETripDataDecoderMobile = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        matchesUrl: 'm.urlaubsenten.com/(buchen)',
        dictionaries: {
            'catering': {
                'AI': 'all-inclusive',
                'AP': 'all-inclusive',
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        name: 'TUI IBE',
        matchesUrl: 'urlaubsenten.reise-wunsch.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
    ...
    $(document).ready(function (e) {
        ...
        dt.Tracking.init('urlaubsenten_exitwindow','UA-105970361-1');
