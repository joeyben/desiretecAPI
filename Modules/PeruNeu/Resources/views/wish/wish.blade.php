...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/peruneu/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/peruneu/css/peruneu.css') }}">
@endsection
...
@section('footer')
    @include('peruneu::layouts.footer')
@endsection
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/peruneu/js/peruneu.js') }}"></script>
@endsection
