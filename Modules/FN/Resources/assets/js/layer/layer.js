...
(function ($) {
    ...
    dt.defaultConfig = {
        ...
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/fn/css/layer/whitelabel.css'
    };
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        name: 'TUI IBE',
        matchesUrl: 'www.fn.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
    ...
    //    matchesUrl: 'fn.com/pauschalreisen',
