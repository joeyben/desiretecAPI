...
/**
 * Class TestHafermannWishesController.
 */
class TestHafermannWishesController extends Controller
{
    ...
    public function view(Wish $wish)
    {
        ...
        return view('testhafermann::wish.wish')->with([
            'wish'                => $wish,
            'avatar'              => $avatar,
    ...
    public function validateTokenList($token)
    {
        if ($this->wish->validateToken($token)) {
            if (Route::has('testhafermann.list')) {
                return redirect()->route('testhafermann.list');
            }
        }
    ...
    {
        //var_dump($request->ip());
        return view('testhafermann::wish.index')->with([
            'status'     => $this->status,
