...
use Modules\Demokreuzfahrtberatung\Http\Requests\StoreWishRequest;

class DemokreuzfahrtberatungController extends Controller
{
    protected $adults = [];
    protected $kids = [];
    protected $catering = [];
    ...
    public function index()
    {
        ...
        return view('demokreuzfahrtberatung::index')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('demokreuzfahrtberatung::layer.created')->with([
