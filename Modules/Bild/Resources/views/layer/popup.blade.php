        ...
        <div class="kwp-row">
            <div class="kwp-col-12 white-col footer-col">
                <div class="kwp-agb">
                    ...
                    <p>Ich habe die <a href="https://bild.reise-wunsch.com/tnb" id="agb_link" target="_blank">Teilnahmebedingungen</a> und <a id="datenschutz" href="https://reisen.bild.de/datenschutz/" target="_blank">Datenschutzrichtlinien</a> zur Kenntnis genommen und möchte meinen Reisewunsch absenden.</p>
                    @if ($errors->any() && $errors->get('terms'))
