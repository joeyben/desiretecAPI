...
use Modules\Ben\Http\Requests\StoreWishRequest;
...
class BenController extends Controller
{
    ...
    {
        $whitelabel = $this->whitelabel->getByName('Ben');

        return view('ben::index')->with([
    ...
    public function store(StoreWishRequest $request, UserRepository $user, WishesRepository $wish)
    {
        ...
        $html = view('ben::layer.created')->with([
