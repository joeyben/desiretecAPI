...
(function ($) {
    ...
    dt.defaultConfig = {
        baseUrl: 'http://soul.com',
        popupPath: '/show',
        popupStore:'/store',
        cssPath: '/whitelabel/soul/css/layer/whitelabel.css'
    };
    ...
    var MasterIBETripDataDecoder = $.extend({}, dt.AbstractTripDataDecoder, {
        ...
        name: 'TUI IBE',
        matchesUrl: 'www.soul.com/(hotel|pauschalreisen|last-minute)(/[a-z-]+)*/suchen|airtours.de',
    ...
    //    matchesUrl: 'soul.com/pauschalreisen',
    ...
    $(document).ready(function (e) {
        ...
        dt.Tracking.init('soul_exitwindow','UA-105970361-1');
    ...
    dt.agbModal = function (e) {
        ...
        function show() {
            ...
            /*$.ajax({
                url: 'http://soul-reisewunsch.com/bundles/cssoul/popup/static/agb.html',
                type: 'GET',
                crossDomain: true,
                dataType: 'jsonp',
