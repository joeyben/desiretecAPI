...
@section('after-styles')
    <link rel="stylesheet" href="{{ asset('whitelabel/kreuzfahrtberatung/css/wish/details.css') }}">
    <link rel="stylesheet" href="{{ asset('whitelabel/kreuzfahrtberatung/css/kreuzfahrtberatung.css') }}">
@endsection
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion1" href="#content">
                                <div class="col-md-12 s2-first">
                                    <h4>{{ trans('wish.details.subheadline.your_wish') }}</h4>
                                    <p>Dies sind Ihre Angaben zu Ihrem Reisewunsch.</p>
                                </div>
...
@section('footer')
    @include('kreuzfahrtberatung::layouts.footer')
@endsection
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="col-md-12 modal-body-bottom">
                        <textarea name="message" id="modal-textarea" class="form-control" placeholder="Worum geht es? Ihre Nachricht an uns."></textarea>
                    </div>
...
@section('before-scripts')
    ...
    <script src="{{ mix('whitelabel/kreuzfahrtberatung/js/kreuzfahrtberatung.js') }}"></script>
@endsection
